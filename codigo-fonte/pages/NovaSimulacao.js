...
const NovaSimulacao = () => {
  ...
  const taxaDebito = 0.01 * 100 + "%"; // 1%
  const taxaCreditoAVista = 0.02 * 100 + "%"; // 2%
  const taxaCredito2a6 = 0.03 * 100 + "%"; // 3%
  const taxaCredito7a12 = 0.04 * 100 + "%"; // 4%
  const taxaAntecipacao = 0.02 * 100 + "% a.m."; // 2%
  ...
  const handleSimularVenda = () => {
    ...
    if (antecipacao === 'Com antecipação') {
      const n = 1;
      ...
      <View style={styles.container}>
        ...
        <Container>
          ...
          <View style={styles.taxasContainer}>
            ...
            <Text>Taxa débito: {taxaDebito}</Text>
            <Text>Taxa crédito à vista: {taxaCreditoAVista} </Text>
            <Text>Taxa crédito 2 a 6: {taxaCredito2a6}</Text>
            <Text>Taxa crédito 7 a 12: {taxaCredito7a12}</Text>
            <Text>Taxa de antecipação: {taxaAntecipacao}</Text>
